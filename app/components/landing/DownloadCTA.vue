<template>
  <section id="download" class="border-t border-white/[0.06] py-20 text-center px-6">
    <h2 class="text-4xl font-bold text-white mb-3">{{ $t('download.headline') }}</h2>
    ...
    <div class="flex justify-center">
      <a
        ...
        aria-label="Download Dibiku for macOS"
        ...
        @click="trackDownload('macOS-arm64')"
      >
...
function trackDownload(platform: string) {
  track('download', { platform, version: '0.3.0' })
}
</script>
