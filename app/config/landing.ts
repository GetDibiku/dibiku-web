...
export const FEATURES = [
  {
    ...
    desc: 'Autocomplete, multi-statement execution, SQL formatter, query variables with :placeholders, EXPLAIN visualizer, and query snippets per engine.',
    stat: 'Full',
  ...
  },
  {
    ...
    desc: 'Scroll millions of rows at 60fps. Inline cell editing, drag-to-select, sticky columns, column stats, row comparison, and Cmd+C/V copy-paste.',
    stat: '60fps',
  ...
  },
  {
    ...
    desc: 'Keychain credential storage, SSH tunnels, SSL/TLS, and built-in data masking to auto-hide sensitive columns like email, phone, and passwords.',
    stat: 'Zero',
  ...
  },
  {
    ...
    desc: '36 shortcuts, command palette, multi-connection tabs, session restore on restart — your hands never leave the keyboard.',
    stat: '36',
  ...
  },
  {
    ...
    desc: 'MySQL, PostgreSQL, SQLite, and Redis — with schema diff to compare databases, foreign key viewer, and engine-specific query support.',
    stat: '4',
  ...
  },
  {
    ...
    desc: 'Schema diff between connections, column statistics, slow query warnings, data masking for PII, and OS notifications for long-running queries.',
    stat: 'Diff',
    statLabel: '& masking tools',
    gradient: ['#0078d4', '#4ec9b0'],
    icon: 'zap',
  },
  {
    title: 'Import & export everything',
    desc: 'CSV/JSON/SQL export, CSV import, copy rows as PHP/Python/Go/Ruby/YAML, database backup & restore, and full table export from context menu.',
    stat: '6+',
