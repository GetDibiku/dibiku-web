...
export const FEATURES = [
  ...
  },
  {
    ...
    desc: 'OS keychain credential storage, full SSH tunnel support with password and key-based auth, SSL/TLS, and built-in data masking to auto-hide PII columns.',
    stat: 'Zero',
    statLabel: 'passwords on disk',
    gradient: ['#059669', '#4ec9b0'],
    icon: 'shield',
    highlights: ['SSH tunnel', 'Key auth', 'SSL/TLS', 'Data masking'],
    isNew: true,
    newLabel: 'SSH tunnels',
  },
  {
